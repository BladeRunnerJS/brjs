caplinx.dashboard.app.model.dialog.TestRunnerDialog = function(oPresentationModel)
{
	...
	this.testResultsLink = new caplin.presenter.node.Field(sTestResultsUrl);
	this.errorMessage = new caplin.presenter.node.Field("");
	this.testsPassed = new caplin.presenter.property.EditableProperty(false);
};
caplin.extend(caplinx.dashboard.app.model.dialog.TestRunnerDialog, caplinx.dashboard.app.model.dialog.DialogViewNode);
