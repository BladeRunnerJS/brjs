...
ko.isWriteableObservable = function (instance) {
    // Observable
    if (instance[protoProperty] === ko.observable && instance instanceof br.presenter.property.WritableProperty) // Caplin change
        return true;
    ...
    return {
        ...
        writeValueToProperty: function(property, allBindingsAccessor, key, value, checkIfDifferent) {
            if (!property || !ko.isObservable(property)) {
                ...
                if (property instanceof br.presenter.property.EditableProperty) // Caplin change
                {
...
//TODO: added by dominicc so that we can use tri-state checkboxes which make use of the js only indeterminate property -- this
//patch needs to be re-applied to the latest version of knockout after we upgrade, if that still doesn't have it
