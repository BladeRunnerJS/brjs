...
ComponentFixtureTest.prototype.setUp = function()
{
	...
	this.m_oMockComponent = mock(br.component.Component);
	...
	this.m_oMockComponentInstance = this.m_oMockComponent.proxy();
...
{
	caplin.component.ComponentFactory.m_mComponentRegistry = {};
...
//			function() {
//				new caplin.component.testing.ComponentFixture();
//			}
//	);
//	assertFails("1b ComponentFixture cannot be constucted without model fixture",
//		function() {
//			new caplin.component.testing.ComponentFixture("<component/>");
//		}
//	);
//	assertFails("1c ComponentFixture cannot be constucted with null model fixture",
//		function() {
//			new caplin.component.testing.ComponentFixture("<component/>", null);
//		}
//	);
//	assertFails("1d ComponentFixture cannot be constucted with invalid model fixture",
//		function() {
//			new caplin.component.testing.ComponentFixture("<component/>", "a string");
//		}
//	);
//	assertFails("1e ComponentFixture cannot be constucted with null XML",
//		function() {
//			new caplin.component.testing.ComponentFixture(null, self.m_oMockModelFixture.proxy());
//		}
//	);
//	assertFails("1f ComponentFixture cannot be constucted with empty XML",
//		function() {
//			new caplin.component.testing.ComponentFixture("", self.m_oMockModelFixture.proxy());
//		}
//	);
//	assertNoException("1g ComponentFixture can be constucted with XML and model fixture parameters",
//		function() {
//			new caplin.component.testing.ComponentFixture("<component/>", self.m_oMockModelFixture.proxy());
//		}
//	);
//};
//
...
//{
//	var oFixture = new caplin.component.testing.ComponentFixture("<component/>", this.m_oMockModelFixture.proxy());
...
//	this.m_oMockViewFixture.expects(once()).setComponent(this.m_oMockComponentInstance); 
//	oComponentFixture.doGiven("opened", true);
//};
//
...
//				oComponent instanceof caplin.component.Component);
//	};
//	
//	this.m_oMockModelFixture.stubs().setComponent(ANYTHING); 
...
//{
//	var oComponentFixture = new caplin.component.testing.ComponentFixture("<component/>", this.m_oMockModelFixture.proxy());
//	
//	this.m_oMockModelFixture.expects(once()).setComponent(this.m_oMockComponentInstance); 
//	oComponentFixture.doGiven("opened", true);
//	
