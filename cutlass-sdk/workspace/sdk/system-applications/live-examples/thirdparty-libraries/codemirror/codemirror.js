...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    // Previnput is a workaround to work with IME. If we reset the textarea
  ...
  CodeMirror.fromTextArea = function(textarea, options) {
    ...
    if (textarea.form) {
      // Deplorable workaround to make the submit method do the right thing.
  ...
  Line.prototype = {
    ...
    // Fetch the parser token for a given character. Useful for workarounds
