brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog = function(oPresentationModel)
{
	// call super constructor
	brjs.dashboard.app.model.dialog.DialogViewNode.call(this, "import-motif-dialog");
	
	this.m_oPresentationModel = oPresentationModel;
	this.m_fOnSuccess = this._onSuccess.bind(this);
	this.m_fOnFailure = this._onFailure.bind(this);
	
	this.appZip = new brjs.dashboard.app.model.form.FileField("application/zip");
...
br.Core.extend(brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog, brjs.dashboard.app.model.dialog.DialogViewNode);

brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog.prototype.initializeForm = function()
{
...
brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog.prototype.importMotif = function()
{
...
brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog.prototype._updateDialog = function()
{
	this._updateAppName();
...
brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog.prototype._updateAppName = function()
{
...
brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog.prototype._updateNamespace = function()
{
...
brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog.prototype._updateCreateButton = function()
{
...
brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog.prototype._onNamespaceChanged = function()
{
	this.m_oPresentationModel.dialog.setAppNamespace(this.appNamespace.value.getValue());
};

brjs.dashboard.app.model.dialog.importDialog.ImportMotifDialog.prototype._onSuccess = function()
{
