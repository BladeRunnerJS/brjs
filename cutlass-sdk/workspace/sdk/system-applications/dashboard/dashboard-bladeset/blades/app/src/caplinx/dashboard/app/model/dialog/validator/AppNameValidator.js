caplinx.dashboard.app.model.dialog.validator.AppNameValidator = function(oPresentationModel)
{
	this.m_oPresentationModel = oPresentationModel;
};
br.Core.extend(caplinx.dashboard.app.model.dialog.validator.AppNameValidator, br.presenter.validator.Validator);

caplinx.dashboard.app.model.dialog.validator.AppNameValidator.prototype.validate = function(vValue, mAttributes, oValidationResult)
{
	...
	if(!caplinx.dashboard.app.NameValidator.isValidDirectoryName(vValue))
	{
		oValidationResult.setResult(false, caplinx.dashboard.app.NameValidator.DIRECTORY_CHARACTERS_MESSAGE);
	}
