...
public class CssResourceContentPluginTest extends SpecTest {
	...
	public void assetsInADefaultAspectThemeCanBeRequested() throws Exception
	{
		...
		when(app).requestReceived("v/dev/cssresource/aspect_default/theme_myTheme/dir1/dir2/someFile.txt", response);
	...
	public void assetsInADefaultAspectResourcesCanBeRequested() throws Exception
	{
		...
		when(app).requestReceived("v/dev/cssresource/aspect_default/resources/dir1/dir2/someFile.txt", response);
		then(response).textEquals("someFile.txt contents");
	}
	...
	public void assetsInABladesetThemeCanBeRequested() throws Exception
	{
		...
		when(app).requestReceived("v/dev/cssresource/bladeset_bs/theme_myTheme/dir1/dir2/someFile.txt", response);
		then(response).textEquals("someFile.txt contents");
	}
	...
	public void assetsInABladesetResourcesCanBeRequested() throws Exception
	{
		...
		when(app).requestReceived("v/dev/cssresource/bladeset_bs/resources/dir1/dir2/someFile.txt", response);
		then(response).textEquals("someFile.txt contents");
	}
	...
	public void assetsInABladeThemeCanBeRequested() throws Exception
	{
		...
		when(app).requestReceived("v/dev/cssresource/bladeset_bs/blade_b1/theme_myTheme/dir1/dir2/someFile.txt", response);
		then(response).textEquals("someFile.txt contents");
	}
	...
	public void assetsInABladeResourcesCanBeRequested() throws Exception
	{
		...
		when(app).requestReceived("v/dev/cssresource/bladeset_bs/blade_b1/resources/dir1/dir2/someFile.txt", response);
		then(response).textEquals("someFile.txt contents");
	}
	...
	public void assetsInABladeWorkbenchThemeCanBeRequested() throws Exception
	{
		...
		when(app).requestReceived("v/dev/cssresource/bladeset_bs/blade_b1/workbench/theme_myTheme/dir1/dir2/someFile.txt", response);
		then(response).textEquals("someFile.txt contents");
	}
	...
	public void assetsInABladeWorkbenchResourcesCanBeRequested() throws Exception
	{
		...
		when(app).requestReceived("v/dev/cssresource/bladeset_bs/blade_b1/workbench/resources/dir1/dir2/someFile.txt", response);
		then(response).textEquals("someFile.txt contents");
	}
	...
	public void assetsInAnSDKLibraryCanBeRequested() throws Exception
	{
		...
		when(app).requestReceived("v/dev/cssresource/lib_sdkLib/resources/dir1/dir2/someFile.txt", response);
		then(response).textEquals("someFile.txt contents");
	}
