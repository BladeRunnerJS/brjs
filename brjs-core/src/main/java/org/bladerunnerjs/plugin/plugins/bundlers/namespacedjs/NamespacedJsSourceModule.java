...
public class NamespacedJsSourceModule implements AugmentedContentSourceModule {
	...
	@Override
 	public List<SourceModule> getDependentSourceModules(BundlableNode bundlableNode) throws ModelOperationException {
		if(!sourceModuleResolvers.containsKey(bundlableNode)) {
			...
			sourceModuleResolvers.put(bundlableNode, new SourceModuleResolver(bundlableNode, assetLocation, requirePath, app.dir(), app.root().sdkLibsDir().dir()));
		}
	...
	public List<SourceModule> getOrderDependentSourceModules(BundlableNode bundlableNode) throws ModelOperationException {
		if(!staticSourceModuleResolvers.containsKey(bundlableNode)) {
			...
			staticSourceModuleResolvers.put(bundlableNode, new SourceModuleResolver(bundlableNode, assetLocation, requirePath, app.dir(), app.root().sdkLibsDir().dir()));
		}
