...
public class LoggingTokenReplacementHandler implements NoTokenReplacementHandler {
	...
	public LoggingTokenReplacementHandler(BRJS brjs, Class<?> loggerClass, String environment, LogLevel logLevel) {
