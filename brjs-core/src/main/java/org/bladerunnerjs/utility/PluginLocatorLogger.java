...
public class PluginLocatorLogger {
	public static void logPlugins(org.bladerunnerjs.api.logging.Logger logger, PluginLocator pluginLocator) {
	...
	private static void listFoundPlugins(org.bladerunnerjs.api.logging.Logger logger, List<? extends Plugin> plugins) {
