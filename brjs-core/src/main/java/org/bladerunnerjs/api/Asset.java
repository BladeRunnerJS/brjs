...
public interface Asset {
	 ...
	 * 
	 * @return String a String object representing the name of the Asset file.
	 */
	String getAssetName();
	 ...
	 * 
	 * @return boolean a boolean object stating whether the Asset may be required by another one.
	 */
