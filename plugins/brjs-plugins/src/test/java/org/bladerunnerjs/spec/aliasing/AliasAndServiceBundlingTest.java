...
public class AliasAndServiceBundlingTest extends SpecTest
{
	...
	public void workbenchesThatRequestTheDevScenarioArentInsteadGivenANonDevNamedGroupInstead() throws Exception
	{
		...
		then(response).containsCommonJsClasses("br/DevScenarioClass")
            ...
            .and(response).containsOrderedTextFragments("define('br/DevScenarioClass'", "define('alias!br.service',", "module.exports = require('br/AliasRegistry').getClass('br.service')", "define('service!br.service',", "module.exports = realm.requireFresh('br/ServiceRegistry').getService('br.service');");
	}
