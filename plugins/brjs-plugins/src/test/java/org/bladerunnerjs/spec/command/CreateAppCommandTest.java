...
public class CreateAppCommandTest extends SpecTest {
	...
	@Test
	public void invalidDirectoryExceptionIsThrownWhenAppNameIsInvalidAndAppNamespaceIsAutoGenerated() throws Exception {
		given(defaultTemplates).templateGroupCreated();
		when(brjs).runCommand("create-app", "...");
	...
	@Test
	public void exceptionIsThrownIfTheAppTemplateDoesNotExist() throws Exception {
	...
	public void emptyFolderIsCreatedIfTemplateForImplicitlyPopulatedAspectDoesNotExist() throws Exception {
		given(angularTemplates.template("app")).containsFile("fileForAppAngular.txt");
		when(brjs).runCommand("create-app", "app", "--template", "angular");
		then(app).hasDir("test-unit")
			.and(app.file("test-unit")).isEmpty();
	}
