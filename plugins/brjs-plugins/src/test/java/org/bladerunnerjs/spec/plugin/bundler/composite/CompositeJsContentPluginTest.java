...
public class CompositeJsContentPluginTest extends SpecTest {
	...
	public void ifThereAreJsFilesThenRequestsWillBeGeneratedInDev() throws Exception {
		...
		then(aspect).devRequestsForContentPluginsAre("js", "js/dev/closure-whitespace/bundle.js", "js/dev/closure-simple/bundle.js", "js/dev/closure-advanced/bundle.js", "js/dev/combined/bundle.js");
	}
	...
	public void ifThereAreJsFilesThenRequestsWillBeGeneratedInProd() throws Exception {
		given(aspect).indexPageRequires("appns/Class")
			.and(aspect).hasClass("appns/Class");
		then(aspect).prodRequestsForContentPluginsAre("js", "js/prod/closure-whitespace/bundle.js", "js/prod/closure-simple/bundle.js", "js/prod/closure-advanced/bundle.js", "js/prod/combined/bundle.js");
	}
