...
public class AnalyserTest
{
	...
	public void testAnalyserOnApp1WithHTMLOutput() throws Exception
	{
		...
		String expected = "<ul>\n"
		 ...
		 + " <li>c1.htm</li>\n"
		 + "</ul><ul>\n"
		 + " <li>htmlfile2.html</li>\n"
		 + "</ul><ul>\n"
		 + " <li>htmlfile1.html</li>\n"
		 + "</ul><ul>\n"
		 + " <li>b2.html<ul>\n"
		 + "  <li>section.a.blade1.htmlDepend</li>\n"
		 + " </ul></li>\n"
		 + "</ul><ul>\n"
		 + " <li>rendererDefinitions.xml</li>\n"
		 + "</ul><ul>\n"
		 + " <li>b2.xml</li>\n"
		 + "</ul><ul>\n"
		 + " <li>somehtml.html</li>\n"
