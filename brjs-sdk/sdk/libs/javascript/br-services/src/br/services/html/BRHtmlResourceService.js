...
function loadHtml(url) {
	...
	// if it isn't presenter we need to XHR in the templates
	...
	if(!templatesLoadedIndicator) {
		...
		var templateContainerChildren = templateContainer.childNodes;
		for (var i = 0, l = templateContainerChildren.length; i < l; ++i) {
			document.querySelector('head').appendChild(templateContainerChildren[i]);
		}
	} else {
