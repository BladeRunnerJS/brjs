(function() {
    ...
    var TooltipControlPresentationModel = require('br/presenter/TooltipControlPresentationModel');
    var GwtTestRunner = require('br/test/GwtTestRunner');

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br/presenter/TooltipControlPresentationModel'] = TooltipControlPresentationModel;

    describe("Floating Tooltip Control tests", function() {
        fixtures( require("br/presenter/TooltipControlFixtureFactory") );
