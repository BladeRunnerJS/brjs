(function() {
    ...
    var TooltipPresentationModel = require('br/presenter/TooltipPresentationModel');
    var GwtTestRunner = require("br/test/GwtTestRunner");

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br/presenter/TooltipPresentationModel'] = TooltipPresentationModel;

    describe("Tooltip Plugin Tests",function() {
        fixtures( require("br/presenter/TooltipPluginFixtureFactory") );
