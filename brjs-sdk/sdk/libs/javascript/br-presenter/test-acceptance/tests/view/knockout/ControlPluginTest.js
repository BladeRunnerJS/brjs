(function() {
    ...
    var ControlPluginPresentationModel = require('br/presenter/ControlPluginPresentationModel');
    var GwtTestRunner = require('br/test/GwtTestRunner');

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br/presenter/ControlPluginPresentationModel'] = ControlPluginPresentationModel;

    describe("View to model interactions for Control Plugin", function() {
        fixtures( require("br/presenter/ControlPluginFixtureFactory") );
