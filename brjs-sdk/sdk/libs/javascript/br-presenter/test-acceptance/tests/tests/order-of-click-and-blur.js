(function() {
    ...
    var OrderOfClickAndBlurPresentationModel = require('br/presenter/OrderOfClickAndBlurPresentationModel');
    var GwtTestRunner = require('br/test/GwtTestRunner');

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br/presenter/OrderOfClickAndBlurPresentationModel'] = OrderOfClickAndBlurPresentationModel;

    describe("Order Of Click & Blur Events", function() {
        fixtures( require("br/presenter/OrderOfClickAndBlurFixtureFactory") );
