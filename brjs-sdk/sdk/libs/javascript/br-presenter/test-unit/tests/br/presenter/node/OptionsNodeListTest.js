(function() {
    ...
    {
        var oOptionList = new OptionsNodeList();
    ...
    {
        var oOptionList = new OptionsNodeList(["a","b","c"]);
    ...
    {
        var oOptionList = new OptionsNodeList({"a": "l1", "b": "l2"});
        var oOptionNodeArray = oOptionList.getOptions();
    ...
    {
        var oProperty = new WritableProperty(["a"]);
        assertException("Properties not allowed inside OptionsNodeList", function(){
            var oOptions = new OptionsNodeList(oProperty);
    ...
    OptionsNodeListTest.prototype.test_getFirstOption = function()
    {
        ...
        var oEmptyOptionList = new OptionsNodeList([]);
        assertNull(oEmptyOptionList.getFirstOption());
    };

    OptionsNodeListTest.prototype.test_getOptionByValue = function()
    {
        var oOptionList = new OptionsNodeList({"aValue": "aLabel", "bValue": "bLabel"});
    ...
    {
        var oOptionList = new OptionsNodeList({"aValue": "aLabel", "bValue": "bLabel", "cValue": "aLabel"});
