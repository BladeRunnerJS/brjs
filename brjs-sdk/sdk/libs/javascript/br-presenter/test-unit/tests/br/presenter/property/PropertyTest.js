(function() {
    ...
    {
        var oFormatterMock = mock(Formatter);
        
        // passes through any config we do provide
        oFormatterMock.expects(atLeastOnce()).format("1.23456789", {key:"value"});
        var oProperty = new WritableProperty().addFormatter(oFormatterMock.proxy(), {key:"value"}).setValue("1.23456789");
        oProperty.getFormattedValue();
        
        // defaults if not provided
        oFormatterMock.expects(atLeastOnce()).format("1.23456789", {});
        var oProperty = new WritableProperty().addFormatter(oFormatterMock.proxy()).setValue("1.23456789");
        oProperty.getFormattedValue();
    };
    ...
    {
        var oProperty = new WritableProperty();
        var oPropertyListener = new PropertyListener();
    ...
    {
        var oProperty = new WritableProperty();
        var oPropertyListener1 = new PropertyListener();
        var oPropertyListener2 = new PropertyListener();
    ...
    PropertyTest.prototype.test_onPropertyChangedIsNotInvokedWhenTheValuesAreNaN = function()
    {
        ...
        // no listeners have been added yet, so won't be informed about 'initial value'
        var oProperty = new WritableProperty().setValue(NaN);
    ...
    {
        var oPropertyListenerMock1 = mock(PropertyListener);
        var oPropertyListenerMock2 = mock(PropertyListener);
    ...
    PropertyTest.prototype.test_instantiatingPropertyWithArrayOfPresentationNodesThrowsAnException = function()
    {
        ...
        var oPresNodeField = new Field();
        var oPresNode = new PresentationNode();

        assertException("1a", function() {
            var oBadProperty = new WritableProperty([oPresNodeField, oPresNode]);
        }, Errors.INVALID_PARAMETERS);
    };
