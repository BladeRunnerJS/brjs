...
EventLogging.evt = function(locator, eventType) {
 ...
 */
EventLogging.verifyEvents = function(expectedEvents) {
...
EventLogging.verifyEventsUnordered = function(expectedEvents, minimumNumberOfActualEvents) {
	actualEvents = eventsRecieved();
...
EventLogging.clearEvents = function() {
	eventsLog.length = 0;
	eventsLog = [];
};
