...
var PageUrlService = require("brjs/dashboard/app/service/url/PageUrlService");
...
Core.inherit(PageUrlProvider, PageUrlService);

PageUrlProvider.prototype.getRootUrl = function() {
	return window.location.href.replace(/dashboard\/[a-z]{2}(_[A-Z]{2})?\/#apps.*$/, '');
};

PageUrlProvider.prototype.getPageUrl = function() {
	return this.m_sPageUrl;
};


PageUrlProvider.prototype.addPageUrlListener = function(fListener, bProvideInitialValue) {
...
PageUrlProvider.prototype.removePageUrlListener = function(sListenerId) {
	delete this.m_mListeners[sListenerId];
};

PageUrlProvider.prototype._updatePageUrl = function(sPageUrl) {
...
module.exports = PageUrlProvider;
