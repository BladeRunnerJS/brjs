brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog = function(oPresentationModel)
{
	// call super constructor
	brjs.dashboard.app.model.dialog.DialogViewNode.call(this, "import-blades-from-app-dialog");
	...
	this.selectedApp = new brjs.dashboard.app.model.dialog.importDialog.AppSelectionField(oPresentationModel);
	this.bladesets = new brjs.dashboard.app.model.dialog.importDialog.SelectableBladesetNodeList(this.selectedApp, oPresentationModel, this.m_fNewBladesetNameValidationListener);
...
br.Core.extend(brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog, brjs.dashboard.app.model.dialog.DialogViewNode);

brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog.prototype.initializeForm = function()
{
	// do nothing
};

brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog.prototype.importBlades = function()
{
...
brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog.prototype._onBladesetsChanged = function()
{
	this.bladesets.properties("isSelected").addChangeListener(this, "_onSelectionChanged", true);
};

brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog.prototype._onSelectionChanged = function()
{
	this._updateDialog();
};

brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog.prototype._getBladesMap = function()
{
...
brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog.prototype._onSuccess = function()
{
...
brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog.prototype._onFailure = function(sFailureMessage)
{
	this.m_oPresentationModel.dialog.displayNotification(sFailureMessage);
};

brjs.dashboard.app.model.dialog.importDialog.ImportBladesFromAppDialog.prototype._updateDialog = function()
{
