...
function InvalidBrowserDecider(oBrowserDetector) {
...
InvalidBrowserDecider.prototype.isValidBrowser = function(oBrowserDetector) {
...
InvalidBrowserDecider.prototype.getMinimumBrowserVersions = function() {
	return this.m_pMinimumBrowserVersions;
};

module.exports = InvalidBrowserDecider;
