...
function BladePresentationNode(sBladeName, oParentBladeset, oPresentationModel) {
	...
	this.bladeName = new Property(sBladeName);
...
Core.extend(BladePresentationNode, PresentationNode);

BladePresentationNode.prototype.runTests = function() {
...
BladePresentationNode.prototype.popoutWorkbench = function() {
	this.m_oPresentationModel.getWindowOpenerService().openWindow(this.workbenchUrl.getValue());
};

BladePresentationNode.prototype._onTestProgress = function(sTestOutput) {
...
BladePresentationNode.prototype._onTestError = function(sErrorMessage) {
	this.m_oPresentationModel.getDashboardService().setTestRunInProgress(false);
	this.m_oPresentationModel.dialog.showDialog('testRunnerDialog');
	this.m_oPresentationModel.dialog.testRunnerDialog.displayTestError(sErrorMessage);
};

module.exports = BladePresentationNode;
