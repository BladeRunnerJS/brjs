...
jasmine.WaitsForBlock.prototype.execute = function(onComplete) {
  /* begin Caplin changes */
  sTheMessage = (this.message != null) ? this.message.getMessage() + "\n" + this.message.getStack() : null;
  if (jasmine.VERBOSE) {
...
define('jasmine', function(require, exports, module) {
module.exports = jasmine;
});


window.jasmine = require('jasmine');
...
define('br-locale-utility', function(require, exports, module) {
module.exports = LocaleUtility;
});


window.br_locale_utility = require('br-locale-utility');
