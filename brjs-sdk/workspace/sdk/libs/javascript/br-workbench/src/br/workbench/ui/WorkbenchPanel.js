 ...
 * @class
 * A <code>WorkbenchPanel</code> is the main container for displaying components within a workbench. Workbench panels 
 *  can be added to a {@link WorkbenchPanel}, either to the left or right side of the screen.
 *
 * @param String orientation Either "left" or "right".
 * @param int width The width of the WorkbenchPanel in Pixels.
 * @param boolean xResizable If True, the panel will be resizable.
 *
 * @constructor
 */
