brjs.dashboard.app.model.apps.AppsScreen = function(oPresentationModel)
{
	...
	this.splashScreen = new brjs.dashboard.app.model.apps.SplashScreen(oPresentationModel);
	this.visible = new br.presenter.property.WritableProperty(false);
	this.apps = new br.presenter.node.NodeList([], brjs.dashboard.app.model.apps.AppSummaryPresentationNode);
	this.newAppButton = new brjs.dashboard.app.model.form.Button("New App", this, "newApp");
	this.importMotifFromZipButton = new brjs.dashboard.app.model.form.Button("Import Motif from ZIP", this, "importMotifFromZip");
...
br.Core.extend(brjs.dashboard.app.model.apps.AppsScreen, br.presenter.node.PresentationNode);

brjs.dashboard.app.model.apps.AppsScreen.prototype.displayApps = function()
{
...
brjs.dashboard.app.model.apps.AppsScreen.prototype.setImportingAppName = function( sImportingAppName )
{
	this.m_sImportingAppName = sImportingAppName;
};


brjs.dashboard.app.model.apps.AppsScreen.prototype.updateApps = function()
{
	this.m_oPresentationModel.getDashboardService().getApps(this.m_fUpdateAppsScreen, this.m_fOnServiceError);
};

brjs.dashboard.app.model.apps.AppsScreen.prototype.newApp = function()
{
	this.m_oPresentationModel.dialog.showDialog("newAppDialog");
};

brjs.dashboard.app.model.apps.AppsScreen.prototype.importMotifFromZip = function()
{
	this.m_oPresentationModel.dialog.showDialog("importMotifDialog");
};

brjs.dashboard.app.model.apps.AppsScreen.prototype._refreshAppsScreen = function(pApps)
{
...
brjs.dashboard.app.model.apps.AppsScreen.prototype._updateAppsScreen = function(pApps)
{
	...
	if( this.m_sImportingAppName !== null )
	{
		...
		var oPlaceHolderAppNode = new brjs.dashboard.app.model.apps.AppSummaryPresentationNode(this.m_sImportingAppName, "", sLoadingImageUrl );
...
brjs.dashboard.app.model.apps.AppsScreen.prototype._onServiceError = function(sErrorResponseText)
{
