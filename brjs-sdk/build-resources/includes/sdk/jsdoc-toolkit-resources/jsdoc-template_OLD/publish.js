...
function publish(symbolSet) {
	...
	//TODO use index.html to publish UX input, remove index.tmpl functionality from here
	var index = indexTemplate.process(classes);
	IO.saveFile(publish.conf.outDir, "index"+publish.conf.ext, index);
	
	try {
		var libraryTemplate = new JSDOC.JsPlate(publish.conf.templatesDir+"library.tmpl");
	}
	
	catch(e) { print(e.message); quit(); }
	var library = libraryTemplate.process(classes);
	IO.saveFile(publish.conf.outDir, "library"+publish.conf.ext, library);
	libraryTemplate = library = classes = indexTemplate = index = null;	
	...
	IO.copyFile(publish.conf.staticDir+"/crumbtrail.css", publish.conf.outDir+"/static");
	...
	IO.copyFile(publish.conf.staticDir+"/chevron-left2.png", publish.conf.outDir+"/static");
	IO.copyFile(publish.conf.staticDir+"/home-hover.png", publish.conf.outDir+"/static");
	IO.copyFile(publish.conf.staticDir+"/home-up.png", publish.conf.outDir+"/static");
	IO.copyFile(publish.conf.staticDir+"/sub-nav.png", publish.conf.outDir+"/static");
	IO.copyFile(publish.conf.staticDir+"/refresh-up.png", publish.conf.outDir+"/static");
