...
caplin.namespace("caplinx.sourceApplication");
// #include caplin.grid.GridGenerator
// #include caplinx.example.helloworld.HelloWorldPresentationModel

caplinx.sourceApplication.TraderApp = function()
{
};

caplinx.sourceApplication.TraderApp.prototype.initWebcentric = function(event)
{
...
caplinx.sourceApplication.TraderApp.prototype.initialiseFactories = function()
{
