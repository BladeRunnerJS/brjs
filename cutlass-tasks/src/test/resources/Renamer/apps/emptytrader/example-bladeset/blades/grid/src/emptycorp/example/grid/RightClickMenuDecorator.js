/**
 * @fileoverview
 * Defines the emptycorp.example.grid.RightClickMenuDecorator class.
 */
caplin.namespace("emptycorp.example.grid");
...
/**
 * Constructs a <code>emptycorp.example.grid.RightClickMenuDecorator</code> instance &mdash; end-users
 ...
 * @constructor
 */
emptycorp.example.grid.RightClickMenuDecorator = function(mDecoratorConfig)
{
	this.m_oContextMenu = this._createContextMenu(mDecoratorConfig);
};
caplin.implement(emptycorp.example.grid.RightClickMenuDecorator, caplin.grid.decorator.GridDecorator);
caplin.implement(emptycorp.example.grid.RightClickMenuDecorator, caplin.grid.GridViewListener);
 ...
 */
emptycorp.example.grid.RightClickMenuDecorator.prototype.setGridView = function(oGridView)
{
 ...
 */
emptycorp.example.grid.RightClickMenuDecorator.prototype.onContainerHtmlRendered = function(oGridView)
{
 ...
 */
emptycorp.example.grid.RightClickMenuDecorator.prototype.onClose = function()
{
 ...
 */
emptycorp.example.grid.RightClickMenuDecorator.prototype.onRowStructureChanged = function(pIndicies)
{
 ...
 */
emptycorp.example.grid.RightClickMenuDecorator.prototype._makeRowClickable = function(oRowElem,nRowIndex)
{
 ...
 * @private
 */
emptycorp.example.grid.RightClickMenuDecorator.prototype._getRightClickHandler = function() 
{
	var self = this;
...
emptycorp.example.grid.RightClickMenuDecorator.prototype._getInstrumentFromSubject = function(sSubjectId, nRowIndex) {
 ...
 * @private
 */
emptycorp.example.grid.RightClickMenuDecorator.prototype._onRightClick = function(oEvent) 
{
 ...
 * @private
 */
emptycorp.example.grid.RightClickMenuDecorator.prototype._createContextMenu = function(oMenuConfig)
{
 ...
 * @private
 */
emptycorp.example.grid.RightClickMenuDecorator.prototype._setupContextMenu = function()
{		
...
emptycorp.example.grid.RightClickMenuDecorator.prototype.newAlertForm = function()
{
	var self = this;
...
emptycorp.example.grid.RightClickMenuDecorator.prototype.insertBenchmark = function()
{	
	var self = this;
...
emptycorp.example.grid.RightClickMenuDecorator.prototype.insertTimeseries = function()
{
	var self = this;
	var fCallback = function(e) {
