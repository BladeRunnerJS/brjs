...
caplin.namespace("ss.slimshady");
// #include caplin.grid.GridGenerator
// #include emptycorp.example.helloworld.HelloWorldPresentationModel

ss.slimshady.SlimShadyApp = function()
{
};

ss.slimshady.SlimShadyApp.prototype.initWebcentric = function(event)
{
...
ss.slimshady.SlimShadyApp.prototype.initialiseFactories = function()
{
