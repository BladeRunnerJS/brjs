...
public class SpecTest extends org.bladerunnerjs.testing.specutility.engine.SpecTest {
	...
	{	
		return BRJSAccessor.initialize(new BRJS (testSdkDirectory, pluginLocator, new AccurateObserverFactory(), new TestLoggerFactory(logging), new ConsoleStoreWriter(output)));
	}
