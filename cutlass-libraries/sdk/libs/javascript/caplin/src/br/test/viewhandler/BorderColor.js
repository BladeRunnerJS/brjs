 ...
 * Example usage:
 * <p>
 * <code>and("tile.view.([identifier=\'FxTileSpot\'] .fxtile_amount .fx_tile_amount_input input).bordercolor = '#1111FF'");</code>
 * </p>
 * 
 * @constructor
...
br.implement(br.test.viewhandler.BorderColor, br.test.viewhandler.ViewFixtureHandler);
