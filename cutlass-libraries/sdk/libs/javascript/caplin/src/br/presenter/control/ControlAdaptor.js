;(function() {
	 ...
	 * 
	 * <ul>
	 *   <li>{@link br.presenter.node.Button}</li>
	 *   <li>{@link br.presenter.node.Field}</li>
	 *   <li>{@link br.presenter.node.SelectionField}</li>
	 *   <li>{@link br.presenter.node.MultiSelectionField}</li>
	 * </ul>
	 * 
	 ...
	 * 
	 * @param {br.presenter.node.PresentationNode} oPresentationNode The presentation node the control
	 * is being bound to.
