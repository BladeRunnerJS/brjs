...
{	
	...
	public static final String JS_MINIFIER_PROPERTY = "jsMinifierSetting";
	...
	public BundlerHandler(BundlableNode bundlableNode, String jsMinifierSetting)
	{
		// legacy paths - these are matched against the last part of the bundle path - e.g. js/js.bundle would match js.bundle
		legacyBundlerHandlerPaths.put("js.bundle", "js/dev/"+jsMinifierSetting+"/bundle.js");
		...
		logicalBundlerHandlerPaths.put("bundle.js", "js/dev/"+jsMinifierSetting+"/bundle.js");
