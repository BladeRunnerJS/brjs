...
public interface TagHandlerPlugin extends Plugin {
	 ...
	 * invoked.</p>
	 * 
	 * @return The name of the tag used in the index page
	 */
	String getTagName();
	
	/**
	 * Writes out the generated content for the given tag, optimized for the specified request mode
	 * @param tagAttributes TODO
	 * @param bundleSet TODO
	 * @param requestMode TODO
	 * @param locale TODO
	 * @param writer TODO
	 * @param version TODO
	 * 
	 * @throws IOException if any exceptions are thrown when writing the tag content
	 */
	 ...
	 * @param locale TODO
	 * 
	 * @throws MalformedTokenException if the token cannot be processed
	 * @throws ContentProcessingException if an exception is encountered when generating the content
	 * 
	 * @return the content paths used by the content which is generated from using this tag
	 */
	 ...
	 * 
	 * @return The list of used content plugin prefixes
	 */
