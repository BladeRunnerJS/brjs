(function() {
    ...
    {
        var oSelectionField = new SelectionField(["option1", "option2"], "option1");
        assertEquals("1a", "", oSelectionField.label.getValue());
        assertEquals("1b", "option1", oSelectionField.value.getValue());
        assertFalse("1c", oSelectionField.hasError.getValue());
        
        oSelectionField = new SelectionField(["option1", "option2"], "option2");
    ...
    SelectionFieldTest.prototype.test_defaultValueCanBePassedIntoConstructorAsEditableProperty = function()
    {
        ...
        var oSelectionField = new SelectionField(["option1", "option2"], oEditableProperty);
        assertEquals("1a", "", oSelectionField.label.getValue());
        assertEquals("1b", "option1", oSelectionField.value.getValue());
        assertFalse("1c", oSelectionField.hasError.getValue());
    };
    ...
    SelectionFieldTest.prototype.test_defaultValuesCannotBePassedIntoConstructorAsNonEditableProperty = function()
    {
        ...
        assertException("1a", function(){
            var oSelectionField = new SelectionField(["option1", "option2"], oProperty);
        }, Errors.INVALID_PARAMETERS);
    };

    SelectionFieldTest.prototype.test_theValueDefaultsToTheFirstOptionIfNotSpecified = function()
    {
        var oSelectionField = new SelectionField(["option1", "option2"]);
        assertEquals("1a", "", oSelectionField.label.getValue());
        assertEquals("1b", "option1", oSelectionField.value.getValue());
        assertFalse("1c", oSelectionField.hasError.getValue());
    };
    ...
    {
        var oSelectionField = new SelectionField(["option1", "option2"], "no-such-option");
        assertEquals("1a", "", oSelectionField.label.getValue());
    ...
    {
        assertException("1a", function(){
            new SelectionField(["option1", "option2"],
    ...
    {
        var oSelectionField = new SelectionField(["option1", "option2", "option3"]);
    ...
    {
        var oSelectionField = new SelectionField(["option1", "option2", "option3"], "option2");
        oSelectionField.automaticallyUpdateValueWhenOptionsChange(true);
    ...
    {
        var oSelectionField = new SelectionField(["option1", "option2", "option3", "option4"], "option3");
        oSelectionField.automaticallyUpdateValueWhenOptionsChange(true);
    ...
    {
        var oSelectionField = new SelectionField(["goodvalue", "badvalue"]);
        oSelectionField.automaticallyUpdateValueWhenOptionsChange(true);
    ...
    SelectionFieldTest.prototype.test_selectedOptionLabelIsInitiallySetToTheCorrectValue = function() {
        var selectionField = new SelectionField(['foo', 'bar'], 'bar');
