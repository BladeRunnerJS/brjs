...
(function() {
    ...
    var RootPresentationNodeContainingList = require('br-presenter/_test-src/RootPresentationNodeContainingList');
    var UpwardRefsPModel = require('br-presenter/_test-src/UpwardRefsPModel');
    var RootPresentationNode = require('br-presenter/_test-src/RootPresentationNode');
