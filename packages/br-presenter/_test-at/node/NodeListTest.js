...
(function() {
    ...
    var NodeListPresentationModel = require('br-presenter/_test-src/NodeListPresentationModel');
    var GwtTestRunner = require('br-test/GwtTestRunner');

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br-presenter/_test-src/NodeListPresentationModel'] = NodeListPresentationModel;

    describe("View to model interactions for NodeList", function() {
        fixtures( require('br-presenter/_test-src/NodeListFixtureFactory') );
