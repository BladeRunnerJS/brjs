...
(function() {
    ...
    var ControlPluginPresentationModel = require('br-presenter/_test-src/ControlPluginPresentationModel');
    var GwtTestRunner = require('br-test/GwtTestRunner');

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br-presenter/_test-src/ControlPluginPresentationModel'] = ControlPluginPresentationModel;

    describe("View to model interactions for Control Plugin", function() {
        fixtures( require('br-presenter/_test-src/ControlPluginFixtureFactory') );
