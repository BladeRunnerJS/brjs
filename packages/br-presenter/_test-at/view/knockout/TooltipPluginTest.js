...
(function() {
    ...
    var TooltipPresentationModel = require('br-presenter/_test-src/TooltipPresentationModel');
    var GwtTestRunner = require('br-test/GwtTestRunner');

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br-presenter/_test-src/TooltipPresentationModel'] = TooltipPresentationModel;

    describe("Tooltip Plugin Tests",function() {
        fixtures( require('br-presenter/_test-src/TooltipPluginFixtureFactory') );
        ...
        beforeEach(function() {
            ...
            document.body.appendChild(TooltipPlugin.element[0]);
