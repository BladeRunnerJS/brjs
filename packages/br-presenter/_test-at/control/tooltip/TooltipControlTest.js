...
(function() {
    ...
    var TooltipControlPresentationModel = require('br-presenter/_test-src/TooltipControlPresentationModel');
    var GwtTestRunner = require('br-test/GwtTestRunner');

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br-presenter/_test-src/TooltipControlPresentationModel'] = TooltipControlPresentationModel;

    describe("Floating Tooltip Control tests", function() {
        fixtures( require('br-presenter/_test-src/TooltipControlFixtureFactory') );
