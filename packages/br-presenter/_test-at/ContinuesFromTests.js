...
(function() {
    ...
    var TestPresentationModel = require('br-presenter/_test-src/TestPresentationModel');
    var GwtTestRunner = require('br-test/GwtTestRunner');

    PresenterComponent.PRESENTATION_MODEL_CLASSES['br-presenter/_test-src/TestPresentationModel'] = TestPresentationModel;
