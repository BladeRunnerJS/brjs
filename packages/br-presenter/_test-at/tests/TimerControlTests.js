...
(function() {
    ...
    var TimerControlPresentationModel = require('br-presenter/_test-src/TimerControlPresentationModel');
    var GwtTestRunner = require('br-test/GwtTestRunner');

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br-presenter/_test-src/TimerControlPresentationModel'] = TimerControlPresentationModel;

    describe("Timer Fixtures use for manually and automatically executing time delayed functions", function(){
      fixtures( require('br-presenter/_test-src/TimerControlFixtureFactory') );
