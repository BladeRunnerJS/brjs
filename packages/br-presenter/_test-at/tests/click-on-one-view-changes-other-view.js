...
(function() {
    ...
    var MultiViewClickPresentationModel = require('br-presenter/_test-src/MultiViewClickPresentationModel');
    var GwtTestRunner = require('br-test/GwtTestRunner');

    GwtTestRunner.initialize();
    PresenterComponent.PRESENTATION_MODEL_CLASSES['br-presenter/_test-src/MultiViewClickPresentationModel'] = MultiViewClickPresentationModel;

    describe("The ability to click on one view of a model and it should change the other view", function() {

        fixtures( require('br-presenter/_test-src/MultiViewClickFixtureFactory') );
