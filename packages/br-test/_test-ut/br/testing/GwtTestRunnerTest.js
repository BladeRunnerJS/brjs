...
(function() {
    ...
    var TestFixtureFactory = require('br-test/_test-src/TestFixtureFactory');
    ...
    GwtTestRunnerTest.prototype.test_DottedNotationForGlobalsIsAllowed = function()
    {
        ...
        window.br.test.TestFixtureFactory = window.br.test.TestFixtureFactory || require('br-test/_test-src/TestFixtureFactory');
