...
(function() {
    ...
    ViewFixtureTest.prototype.setUp = function() {
        this.m_oViewFixture = new ViewFixture();
        this.m_oViewFixture.setViewElement(this.getFormElement());

        this.m_oViewFixtureForFxTicket = new ViewFixture();
    ...
    ViewFixtureTest.prototype.test_canAddANewHandler = function() {
        ...
        assertException('no existing handler exists', assertionFunc, Errors.INVALID_TEST);
