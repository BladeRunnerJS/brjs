...
(function() {
    ...
    var EventLogging = require('br-test/_test-src/EventLogging');
    var TestUtils = require('br-test/_test-src/TestUtils');
    // TODO: fixtures() needs to be made CommonJS friendly
    window.ViewFixtureTestsFixtureFactory = require('br-test/_test-src/ViewFixtureTestsFixtureFactory');
