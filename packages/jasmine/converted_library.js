...
jasmine.Spec.prototype.waitsFor = function(latchFunction, optional_timeoutMessage, optional_timeout) {
  ...
  /* begin Caplin changes */
  latchFunction_ = arguments[0];
  optional_timeoutMessage_ = arguments[1];
  optional_timeout_ = arguments[2];
  /* end Caplin changes */
...
jasmine.WaitsForBlock.prototype.execute = function(onComplete) {
  /* begin Caplin changes */
  sTheMessage = (this.message != null && this.message.getMessage) ? this.message.getMessage() + "\n" + this.message.getStack() : this.message;
  if (jasmine.VERBOSE) {
    this.env.reporter.log('>> Jasmine waiting for ' + (sTheMessage || 'something to happen'));
  }
  /* end Caplin changes */
  ...
  if (latchFunctionResult) {
	...
	/* begin Caplin changes */
    var message = 'timed out after ' + this.timeout + ' msec waiting for ' + (sTheMessage || 'something to happen');
    /* end Caplin changes */
    this.spec.fail({
      name: 'timeout',
      message: message
...
if (typeof module !== "undefined") module.exports = (Object.keys(module.exports).length || typeof module.exports === "function") ? module.exports : jasmine;

window.jasmine = (typeof module !== "undefined" && module.exports) || jasmine;
