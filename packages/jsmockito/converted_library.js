...
JsMockito.mock = function(Obj) {
  ...
  MockObject.prototype = new IntermediateObj;
  ...
  if(Object.create)
  {
	  function getDescriptors(mockObject){
		  ...
		  {
			  descriptor[methodName] = {enumerable: true, configurable: true, writable: true, value: null};
		  }
		  
		  return descriptor;
	  }
	  
	  MockObject.prototype = Object.create(Obj.prototype, getDescriptors(Obj.prototype));
...
if (typeof module !== "undefined") module.exports = (Object.keys(module.exports).length || typeof module.exports === "function") ? module.exports : JsMockito;

window.JsMockito = (typeof module !== "undefined" && module.exports) || JsMockito;

window.jsmockito = typeof require == 'function' && require('jsmockito');
