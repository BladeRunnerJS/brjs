 ...
 *
 * @author BalusC http://balusc.blogspot.com/2009/02/fileservlet-supporting-resume-and.html
 */
public class FileServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7109594952633819559L;
...
//	private static final long DEFAULT_EXPIRE_TIME = 604800000L; // ..ms = 1 week.
	...
	public void init() throws ServletException {
		...
		String basePathParam = getInitParameter("basePath");
		if (basePathParam == null || basePathParam.equals("")) {
			throw new ServletException("FileServlet init param 'basePath' is required.");
		}
		// Get base path (path to get all resources from) as init parameter.
		this.basePath = getServletContext().getRealPath("/")+"/"+basePathParam;
	}
